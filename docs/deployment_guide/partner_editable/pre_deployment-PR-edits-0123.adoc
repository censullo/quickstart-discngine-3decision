...
You will then be able to enter the ARN of your copied snapshot in the AWS CloudFormation parameters. If field is left blank, the unencrypted latest snapshot will be used.
...
*Q*: What is an AWS Partner Solution? In more detail, what is this “AWS Quick Starts process”? Is it Cloudformation templates, CDK scripts or something third?

*A*: For information about Partner Solutions, refer to the https://aws-ia.github.io/content/qs_info.html[AWS Partner Solution General Content Guide]. 3decision is a AWS Biotech Blueprint Partner Solution that uses CloudFormation templates. When you deploy the 3decision Partner Solution, the CloudFormation console opens.
