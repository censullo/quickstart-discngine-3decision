...
* *Deploy {partner-product-short-name} into an existing VPC*. This option creates an EKS cluster, and then provisions {partner-product-short-name} in your existing AWS infrastructure.
* *Deploy {partner-product-short-name} into an existing VPC and existing EKS cluster*. This option provisions {partner-product-short-name} in your existing AWS infrastructure.
